...
/* -----------FOR LOOP FOR SCHEDULE --------------*/
//    for (var x in doctor_data) {
//    $('.calendar').fullCalendar('renderEvent', {id:4,title:"Monday",dow:[x.day],start: x.time_slot_from,end:x.time_slot_to  }, true);
//
//}
