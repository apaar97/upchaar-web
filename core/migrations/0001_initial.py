# Generated by Django 2.0.3 on 2018-03-20 19:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Role',
            fields=[
                ('id', models.PositiveSmallIntegerField(choices=[(1, 'Patient'), (2, 'Doctor'), (3, 'Hospital'), (4, 'Admin')], primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Doctor',
            fields=[
                ...
                ('education', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Education')),
            ],
        ),
        migrations.CreateModel(
            name='Hospital',
